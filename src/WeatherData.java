 ...
 *
 * 依據SPEC
 * [Area] is limited to “US” and “Asia” and each type will only have one instance.
 *
 * 應該是"各"一個instance
 */
...
//    }
    ...
    public void add(DisplayType displayType){
        ...
        this.displayTypeList.stream().filter( displayType1 -> displayType1.equals(displayType)).findFirst();
        if(!result.isPresent()){
    ...
    /**
     * 確認當下 Area 跟 模式 然後列印
     * 如果沒有被attach任何 displayType 就不列印
     */
